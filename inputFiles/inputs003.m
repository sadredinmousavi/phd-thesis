...
eq_times = [0, 5, 5, 20, 20];  % Some times repeat
% eq_times = [10,];
eq_positions = [
     0.00,  0.00;
    -0.10 , 0.00;
...
useSavedData = false; 
filename = 'case_003.mat'; 
sim = sim.calcEquilibrium(useSavedData, filename);
sim.generateExperimentalInputs('experimental_inputs_003.txt');
...
sim.createSimulationVideo('robot_simulation_003.mp4', ...
